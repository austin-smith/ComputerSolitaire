...
- **Stock:** Three face-down cards, dealt face up onto the first three piles at any time — once.

## Setup
- Use a standard 52-card deck (no jokers).
- **Tableau:** Deal 49 cards into seven piles of seven. In each of the **first four piles** the bottom three cards are face down; the **last three piles** are entirely face up.
...
### The stock
- Tapping the stock deals its **three cards face up, one onto each of the first three piles** — empty or mid-run piles included.
