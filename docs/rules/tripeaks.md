...
## Terminology
- **Peaks:** Twenty-eight cards in three overlapping peaks, with face-down rows of three, six, and nine over a face-up base row of ten. Each card except the base row is covered by two cards below it.
...
- **Peaks:** Deal 28 cards into the three-peak layout, with three face-down rows (three peak cards, then six, then nine) under the face-up ten-card base row that the peaks share.
