...
///   - timeout: Seconds to wait for the network loading indicator to disappear.
///     Pass `0` to skip waiting.
@MainActor
...
open class Snapshot: NSObject {
    ...
    open class func snapshot(_ name: String, timeWaitingForIdle timeout: TimeInterval = 20) {
        ...
        if Snapshot.waitForAnimations {
            ...
            do {
                // Parallel UI tests prefix cloned simulator names with "Clone X of ".
