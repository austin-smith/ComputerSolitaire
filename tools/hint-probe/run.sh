...
# Usage: tools/hint-probe/run.sh <yukon|klondike|freecell|spider|pyramid|tripeaks|golf|fortythieves|scorpion|all> [seeds] [klondike draw count | spider suit count]
set -euo pipefail
